...
const index = () => {
  return (
    <main className="relative grid sm:grid-cols-1 lg:grid-cols-12 w-full gap-2 lg:gap-6 2xl:gap-x-32 bg-primary xl:bg-transparent">
      ...
      <section className="lg:inline lg:col-span-5 justify-center lg:mt-32  px-4 py-2 sm:px-6 lg:px-8 lg:py-14 relative lg:right-24">
        <NetxuiImage
          as={Image}
          width={400}
          height={200}
          className="w-full rounded-md mt-20"
          src="/images/about.webp"
          alt="Image Description"
        />
        <div className="hidden lg:inline absolute inset-0 top-[8%] -z-[2] h-3/4 bg-secondary w-[600px] mt-4 rounded-r-md shadow-md" />
      </section>
    </main>
  );
};
