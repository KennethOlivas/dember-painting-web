...
const WorkSection = () => {
  return (
    <section className="w-full bg-primary rounded-lg md:py-24 mt-24">
      <Card className="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
